        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('pengurus.ranting.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2 space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nama_ranting" name="nama_ranting" type="text" class="mt-1 block w-full" required autofocus />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="nama_ketua" name="nama_ketua" type="text" class="mt-1 block w-full" />
                                    </div>
                                    <div>
                                        <x-input-label for="masa_khidmat" :value="__('Masa Khidmat (Contoh: 2024-2026)')" />
                                        <x-text-input id="masa_khidmat" name="masa_khidmat" type="text" class="mt-1 block w-full" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-2 space-y-4 mt-4">
                                ...
                                <p class="text-sm text-gray-500">Kosongkan atau isi 0 jika tidak ada.</p>

                                <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                                    <div>
                                        <x-input-label for="makesta" :value="__('Makesta')" />
                                        <x-text-input id="makesta" name="makesta" type="number" min="0" class="mt-1 block w-full" value="0" />
                                    </div>
                                    <div>
                                        <x-input-label for="lakmud" :value="__('Lakmud')" />
                                        <x-text-input id="lakmud" name="lakmud" type="number" min="0" class="mt-1 block w-full" value="0" />
                                    </div>
                                    <div>
                                        <x-input-label for="latin" :value="__('Latin')" />
                                        <x-text-input id="latin" name="latin" type="number" min="0" class="mt-1 block w-full" value="0" />
                                    </div>
                                    <div>
                                        <x-input-label for="lakut" :value="__('Lakut')" />
                                        <x-text-input id="lakut" name="lakut" type="number" min="0" class="mt-1 block w-full" value="0" />
                                    </div>
                                    <div>
                                        <x-input-label for="laknas" :value="__('Laknas')" />
                                        <x-text-input id="laknas" name="laknas" type="number" min="0" class="mt-1 block w-full" value="0" />
                                    </div>
                                </div>
                            </div>
                        </div>
