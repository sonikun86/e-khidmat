                    ...
                    <form action="{{ route('admin.surat.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <x-text-input id="nomor_surat" name="nomor_surat" type="text" class="mt-1 block w-full" required autofocus placeholder="Contoh: 001/PCNU/V/2026" />
                            ...
                            <div>
                                ...
                                <select id="penerima" name="penerima" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    <option value="Semua PAC" class="font-bold text-indigo-600">Ke Semua PAC</option>
                                    @foreach($pacs as $pac)
